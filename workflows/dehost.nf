...
workflow dehost {
    ...
    main:
      bwa_mem(ch_fastq_input.combine(ch_host_reference))
      samtools_flagstat(bwa_mem.out)
      remove_mapped_reads(bwa_mem.out)
      extract_fastq_from_bam(remove_mapped_reads.out)
